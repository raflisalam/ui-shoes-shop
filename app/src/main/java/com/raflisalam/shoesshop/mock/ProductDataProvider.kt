package com.raflisalam.shoesshop.mock
...
import com.raflisalam.shoesshop.ui.theme.Product_2
import com.raflisalam.shoesshop.ui.theme.Product_3
import com.raflisalam.shoesshop.ui.theme.Product_4
import com.raflisalam.shoesshop.ui.theme.Product_5
import com.raflisalam.shoesshop.ui.theme.Product_6
import com.raflisalam.shoesshop.ui.theme.Product_7
import com.raflisalam.shoesshop.ui.theme.Product_8
...
fun generateProducts(): List<ProductUiModel> {
    ...
    for (i in 1 .. 8) {
        ...
        productList.add(
            ProductUiModel(
                imgResource = drawableMap[i]?.first ?: fallbackResource.first,
